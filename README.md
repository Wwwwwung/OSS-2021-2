...
> [1] 김두식 외 (2017), 한글 폰트의 품질 검사 및 폰트 정보 검색을 위한 영상 인식 기술 개발, 한국전자통신연구원.

> [2] 전자연 외 4인 (2020), 글꼴 유사도 판단을 위한 Faster R-CNN 기반 한글 글꼴 획 요소 자동 추출, 한국미디어학회논문지, 제23권 8호, p953-964.

> [3] 박문호 외 3인 (1997), 인공지능 : 인쇄된 한글 문서의 폰트 인식, 정보처리학회논문지, 제4권 8호, p2017-2024.

> [4] 심성하, 이강배, 박성호 (2020), 딥 러닝 기법을 활용한 이미지 내 한글 텍스트 인식에 관한 연구, 한국융합학회논문지, 제11권 6호, p1-6.
